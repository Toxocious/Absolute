        ...
        .then((Roster_Data) => {
            ...
            for (let Slot = 0; Slot < Roster_Data.Roster_Pokemon.length; Slot++) {
                ...
                if (typeof Pokemon_Slot === 'undefined') {
                    ...
                    if (Pokemon_Slot.Nickname) Nickname = Pokemon_Slot.Nickname;
                    else
                        Nickname =
                ...
                if (typeof Pokemon_Slot !== 'undefined') {
                    ...
                    document
                        .getElementById(`Roster_Slot_${Slot + 1}_Button`)
                        .setAttribute('onclick', `UpdateNickname(${Pokemon_Slot.ID}, ${Slot + 1})`);
                }
            }
        })
...
async function UpdateNickname(Pokemon_ID, Roster_Slot) {
    ...
    await SendRequest('nickname', Form_Data)
        .then((Nickname_Data) => {
            ...
            document.getElementById('Pokemon_Center_Nickname_AJAX').className =
                Nickname_Data.Success ? 'success' : 'error';
            document.getElementById('Pokemon_Center_Nickname_AJAX').innerHTML =
                Nickname_Data.Message;
