<?php
  ...
  class Pain_Split extends Battle
  {
    public $Name = null;
    ...
    )
    {
      ...
      $Total_HP = floor($Attacker->HP + $Defender->HP) / 2;
      foreach ( [$Attacker, $Defender] as $Battle_Side )
      {
        if ( $Battle_Side->HP + $Total_HP > $Battle_Side->Max_HP )
          $Battle_Side->HP = $Battle_Side->Max_HP;
        else
          $Battle_Side->HP = $Total_HP;
      }


      $Effect_Text = 'The battlers shared their pain!';
