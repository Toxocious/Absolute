<?php
  ...
  class Hail extends Battle
  {
    ...
    )
    {
      ...
      if ( in_array($this->Weather->Name, ['Strong Winds', 'Hail', 'Heavy Rain', 'Extremely Harsh Sunlight']) )
      {
      ...
      else
      {
        ...
        $Turns = 5;
        if ( $Attacker->Item->Name == 'Icy Rock' )
          $Turns = 8;

        $Set_Weather = new Weather('Hail', $Turns);
