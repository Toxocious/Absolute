<?php
  ...
  class Reversal extends Battle
  {
    ...
    )
    {
      ...
      $HP_Percentage = round(($Attacker->HP / $Attacker->Max_HP) * 100, 2);
      if ( $HP_Percentage >= 68.75 )
        $this->Power = 20;
      else if ( $HP_Percentage >= 35.42 && $HP_Percentage < 68.75 )
        $this->Power = 40;
      else if ( $HP_Percentage >= 20.83 && $HP_Percentage < 35.42 )
        $this->Power = 80;
      else if ( $HP_Percentage >= 10.42 && $HP_Percentage < 20.83 )
        $this->Power = 100;
      else if ( $HP_Percentage >= 4.17 && $HP_Percentage < 10.42 )
        $this->Power = 150;
      else
        $this->Power = 200;
