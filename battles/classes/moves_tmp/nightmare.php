<?php
  ...
  class Nightmare extends Battle
  {
    public $Name = null;
    ...
    )
    {
      ...
      {
        $Attacker->SetStatus('Nightmare');

        $Effect_Text = "{$Attacker->Display_Name} took aim at {$Defender->Display_Name}!";
      }
