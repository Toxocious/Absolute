<?php
  ...
  class Mean_Look extends Battle
  {
    public $Name = null;
    ...
    )
    {
      ...
      if
      (
        $Defender->HasTyping(['Ghost']) ||
        $Defender->HasStatus('Trapped')
      )
      {
      ...
      {
        $Defender->SetStatus('Trapped');

        $Effect_Text = "{$Defender->Display_Name} can no longer escape!";
      }
    ...
    )
    {
      ...
      if
      (
        $Defender->HasStatus('Semi-Invulnerable') ||
        $Defender->HasStatus('Fly') ||
        $Defender->HasStatus('Dig') ||
        $Defender->HasStatus('Crafty Shield')
      )
        return false;
