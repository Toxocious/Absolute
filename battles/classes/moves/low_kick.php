<?php
  ...
  class Low_Kick extends Battle
  {
    ...
    )
    {
      ...
      if ( $Defender->Weight >= 0.1 && $Defender->Weight <= 9.9 )
        $this->Power = 20;
      else if ( $Defender->Weight >= 10.0 && $Defender->Weight <= 24.9 )
        $this->Power = 40;
      else if ( $Defender->Weight >= 25.0 && $Defender->Weight <= 49.9 )
        $this->Power = 60;
      else if ( $Defender->Weight >= 50.0 && $Defender->Weight <= 99.9 )
        $this->Power = 80;
      else if ( $Defender->Weight >= 100.0 && $Defender->Weight <= 199.9 )
        $this->Power = 100;
      else
        $this->Power = 120;
