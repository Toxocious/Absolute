const Moves = {
        ...
        onHitField: function (target, source) {
            ...
            if (this.gameType === "freeforall") {
                ...
                for (var _i = 0, sideConditions_1 = sideConditions; _i < sideConditions_1.length; _i++) {
                    ...
                    if (!someCondition)
                        continue;
                    _a = __spreadArray([], rotatedSides), sides[0].sideConditions[id] = _a[0], sides[1].sideConditions[id] = _a[1], sides[2].sideConditions[id] = _a[2], sides[3].sideConditions[id] = _a[3];
    ...
    mimic: {
        ...
        flags: { protect: 1, authentic: 1, mystery: 1 },
        onHit: function (target, source) {
            var disallowedMoves = ['chatter', 'dynamaxcannon', 'mimic', 'sketch', 'struggle', 'transform'];
            var move = target.lastMove;
