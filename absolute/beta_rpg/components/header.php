...
<section class='user-bar <?= $User_Session ? 'logged-in' : 'logged-out'; ?>'>
    ...
    <div class='social-links'>
        <div>
            <a href='https://discord.gg/SHnvbsS' target='_blank' rel='noopener noreferrer' style='color: var(--bg-success); font-size: 1.5em;' class='tooltip tooltip-below' data-tooltip='Join us on Discord!'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" width="24"
    height="24">
        ...
        <div>
            <a href='https://github.com/toxocious/absolute' target='_blank' rel='noopener noreferrer' style='color: var(--bg-success); font-size: 1.5em;' class='tooltip tooltip-below' data-tooltip='View our GitHub!'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" width="24"
    height="24">
                        ...
                        if ( $Roster_Pokemon_Data === null )
                        {
                            echo "
                                <div class='user-roster-slot empty'>
                                    <img src='/assets/images/Pokemon/Icons/Empty.png' alt='Empty Slot' />
                                </div>
                            ";
