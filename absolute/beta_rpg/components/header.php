...
<section class='user-bar <?= $User_Session ? 'logged-in' : 'logged-out'; ?>'>
    ...
    <div class='social-links'>
        <div>
            <a href='https://discord.gg/SHnvbsS' target='_blank' rel='noopener noreferrer' style='color: var(--bg-success); font-size: 1.5em;'>
        ...
        <div>
            <a href='https://github.com/toxocious/absolute' target='_blank' rel='noopener noreferrer' style='color: var(--bg-success); font-size: 1.5em;'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div class='user-info'>
            ...
            <div class='user-roster'>
                <div class='user-roster-slot'>
                    <img src='https://localhost/images/Pokemon/Icons/Normal/359.png' alt='Absol' />
                </div>
                <div class='user-roster-slot'>
                    <img src='https://sprites.tpkrpg.net/misc/empty.png' alt='Empty Slot' />
                </div>
                <div class='user-roster-slot'>
                    <img src='https://sprites.tpkrpg.net/misc/empty.png' alt='Empty Slot' />
                </div>
