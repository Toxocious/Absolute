  ...
  <div class='body' style='padding: 5px;'>
    <div class='flex' style='justify-content: center;'>
      <div style='flex-basis: 100%;' id='BattleWindow'>
        <div>
          <div class='flex' style='flex-wrap: wrap; flex-direction: row; justify-content: center;'>
            <!-- Ally Pokemon Data (Roster, Stat Mults, Active Pokemon) -->
            ...
            <!-- Battle Controls (Weather, Settings, Bag) -->
            ...
            <!-- Foe Pokemon Data (Roster, Stat Mults, Active Pokemon) -->
            <div style='flex-basis: 39%;'>
              <div class='flex' style='justify-content: center;'>
                <div class='border-gradient hover' style='margin-right: 5px;'>
          ...
          <!-- Battle Dialogue -->
          <div class='border-gradient' style='width: 70%; margin: 5px auto 0;'>
