<?php
  ...
  class Sunny_Day extends Battle
  {
    public $Name = null;
    ...
    )
    {
      ...
      if ( in_array($this->Weather->Name, ['Strong Winds', 'Heavy Rain', 'Harsh Sunlight', 'Extremely Harsh Sunlight']) )
      {
      ...
      else
      {
        ...
        $Turns = 5;
        if ( $Attacker->Item->Name == 'Damp Rock' )
          $Turns = 8;

        $Set_Weather = new Weather('Rain', $Turns);
