<?php
  ...
  class Twister extends Battle
  {
    ...
    )
    {
      ...
      if ( $Defender->HasStatusFromArray(['Fly', 'Bounce', 'Sky Drop']) )
        $Damage *= 2;
    ...
    )
    {
      ...
      if ( $Defender->HasStatusFromArray(['Semi-Invulnerable', 'Dig', 'Dive']) )
        return false;
