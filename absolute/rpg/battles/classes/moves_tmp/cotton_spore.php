<?php
  ...
  class Cotton_Spore extends Battle
  {
    public $Name = null;
    ...
    )
    {
      ...
      if
      (
        $Defender->IsFieldEffectActive('Mist') ||
        $Defender->Active->HasTyping(['Grass']) ||
        $Defender->Active->Ability == 'Overcoat' ||
        $Defender->Active->Item == 'Safety Goggles'
      )
      {
