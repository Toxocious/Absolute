<?php
  ...
  class Magnitude extends Battle
  {
    public $Name = null;
    ...
    )
    {
      ...
      {
        $this->Power = 10;
        $Effect_Text = 'Magnitude 4!';
      }
      else if ( $Probability > 5 && $Probability <= 15 )
      {
        $this->Power = 30;
        $Effect_Text = 'Magnitude 5!';
      }
      else if ( $Probability > 15 && $Probability <= 35 )
      {
        $this->Power = 50;
        $Effect_Text = 'Magnitude 6!';
      }
      else if ( $Probability > 35 && $Probability <= 65 )
      {
        $this->Power = 70;
        $Effect_Text = 'Magnitude 7!';
      }
      else if ( $Probability > 65 && $Probability <= 85 )
      {
        $this->Power = 90;
        $Effect_Text = 'Magnitude 8!';
      }
      else if ( $Probability > 85 && $Probability <= 95 )
      {
        $this->Power = 110;
        $Effect_Text = 'Magnitude 9!';
      }
      else
      {
        $this->Power = 150;
        $Effect_Text = 'Magnitude 10!';
      }
      ...
      if ( isset($this->Terrain) && $this->Terrain == 'Grassy' )
        $Damage /= 2;
