<?php
  ...
  class Hidden_Power extends Battle
  {
    public $Name = null;
    ...
    )
    {
      ...
      $Fetch_Move_Type = $this->DetermineMoveType($Attacker->IVs);
      $this->Move_Type = $Fetch_Move_Type;
    ...
    /**
     * Determine what this move's move-type should be.
     */
